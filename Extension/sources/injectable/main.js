...
class mcsSimulator {
        ...
        computeCombatStats() {
                ...
                if ((items[weaponID].type === 'Ranged Weapon') || items[weaponID].isRanged) {
                        ...
                        if (this.parent.gearSelected[CONSTANTS.equipmentSlot.Weapon] == CONSTANTS.item.Cloudburst_Staff && this.attackType == 2 && (this.selectedSpell === 1 || this.selectedSpell === 5 || this.selectedSpell === 9 || this.selectedSpell === 13 || this.selectedSpell === 17)) {
        ...
        if (isLoaded) {
                ...
                if (tryLoad) {
                        try {
                                ...
                                if (wrongVersion) {
                                        console.log('Melvor Combat Sim v0.8.1 Loaded, but simulation results may be inaccurate.')
                                } else {
                                        console.log('Melvor Combat Sim v0.8.1 Loaded');
                                }
                        } catch (error) {
